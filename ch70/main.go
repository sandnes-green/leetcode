...
// 如果 n = 0，即爬0级，我们看成是1种方案，即 f(0) = 1

// 如果 n = 1，即爬1级，我们也只需要走一步即可，即f(1) = 1

// 那么f(2) = f(1) + f(0) = 2，即如果有两阶，我们有两种方法，1阶爬两次或者是一次爬2阶

// f(3) = f(2) + f(1) = 3，如果有三阶，我们有三种方法，1阶爬三次，先爬1阶再爬2阶，先爬2阶再爬1阶
// 由此类推，这就是一个典型的斐波那契数列
package main
